...
def cadstro_pessoa():
    ...
    endereço = {logradouro, nro, bairro, Cidade, Estado}

    Pessoa = {nome, dtn, cpf, endereço}
    print(Pessoa)
...
def F():
    global T
    T = False
    print(f"O programa encerra aqui {conta}, tenha um bom dia!")
    return T
